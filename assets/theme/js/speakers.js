...
},
{
    ...
    bio: "I built a talking duck!  \
          <br />\
          <br />I'm a frequent speaker at BSides Cape Town and DevConf. \
          <br />\
          <br />I’ve been professionally developing software since 2000. I’m comfortable in multiple development environments and platforms and have worked on everything from big data distributed systems and large retail in-store and stock-take systems written in .NET to Linux kernel drivers and code running on 8-bit micro-controllers.",
...
<br /> \
<br /> Miss Duckworth is a large 3D printed duck that is capable of having discussions with you and runs all of the AI models locally without internet access. \
<br /> Using machine learning, various image recognition libraries and multimodal AI models I want to add basic vision capabilities to the duck. \
<br /> Be able to ask it questions about what it 'sees' and have the duck answer back. Have the duck recognise people and try have conversations with them. \
<br /> \
<br /> This talk covers how I got this to work, if it works, and all the tools and libraries required to do image processing offline using low powered computers without GPU's etc.",
...
<br />\
<br />We will be discussing: \
<br />How we addressed siloed operations and lack of standardisation in our processes\
<br />The development of a framework to address these issues\
<br />The benefits realised by the adoption of this framework\
<br />How we see the framework evolving in the future",
...
<br /> \
<br /> In this session, I will talk about my team's experiences in bringing engineering principles normally applied to data pipelines all the way to the reporting layer (specifically Tableau).\
<br /> \
<br /> Using existing APIs, we are able to do interesting things.\
<br /> - Fist, discover how far the reporting landscape go (how big is the bus factor) so we can refactor reports in line with software engineering practices. \
<br /> - Second, treat reporting as artefacts that we can manage by an automated pipeline (a la CI/ CD).\
<br /> - Third, expand data quality checks to the reporting layer so our business consumers can be notified of quality issues as soon as they occur. \
...
He enjoys showing people new tools and technologies that allow them to work more effectively with their data. ",
    ...
    talk: "For over 40 years, the relational database has been the de facto database architecture used by organizations large and small to power their applications. more recently we have seen other alternatives emerge that could be better suited to the application requirements. \
    <br /> <br />This talk will look at 5 types of databases that may be better alternatives. ",
...
<br />\
<br/>My talk will focus on my experience designing programmes that develop junior data professionals into well-rounded individuals. I will explore the following key areas:\
<br />\
<br />- Design for the future: Today’s graduates will eventually become managers, and technical expertise alone does not create impactful and inspiring leaders. How can we start cultivating leadership qualities to prepare juniors for effectiveness in future roles?\
<br />- Recognising the unknown: New professionals often feel the need to overwork to prove their worth, adopting a jack-of-all-trades approach while mastering very little. Instead of pursuing multiple paths, how can we guide them towards a focused direction and refine their learning process?\
<br />- Learning how to learn: The data industry is constantly evolving, making continuous learning an essential skill. How can we equip graduates with future-proof skills that will form the foundation of their data careers?\
<br />- Developing professional skills remotely: Remote work removes the opportunity to learn by observing others in person. How can we still teach professional behaviour virtually?\
<br />- Balancing technical and soft skills: While technical skills are crucial for data professionals, being a successful team member requires a lot of soft skills. How do we strike a balance between technical development and personal growth and emphasise the value of both?\
<br />- It takes a village: Starting a career can be an overwhelming experience, but success is more likely when supported by a community of relatable peers. How can we foster such communities to support junior professionals on their journey and help them build their professional network at the same time?",
...
$(document).ready(function() {
  for (var i = 0; i < modalData.length; i++) {
    ...
    modal.find(".modal-img").html("<img src=\"assets/images/speakers_2024/speaker_" + first_name.toLowerCase() + ".png\" />"); 
